<template>
    <div
        class="w-full cursor-pointer bg-white rounded-xl shadow-[0px_2px_12px_0px_rgba(0,0,0,0.16)] inline-flex flex-col justify-start items-start overflow-hidden transition-all duration-200 group border hover:border-primary"
    >
        <div
        ...
        >
            ...
            <div
                class="absolute bottom-0 right-0 w-full h-auto flex justify-center items-center gap-6 glassmorphism2 p-3 transition-all duration-200 lg:translate-y-full translate-y-0 group-hover:translate-y-0"
            >
                <div
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <p
                        class="w-full inline-block text-zinc-900 text-lg font-medium leading-normal h-14 overflow-hidden text-center leading-relaxed"
                    >
