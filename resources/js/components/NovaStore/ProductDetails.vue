                    ...
                    <div class="w-full px-4 lg:pl-0 2xl:px-0">
                        ...
                        >
                            ...
                            >
                                <span class="star">
                                    <span
                                        style="display: block; width: 18px; height: 18px; background-color: var(--primary); -webkit-mask: url('/assets/images/box-check.png') no-repeat center / contain; mask: url('/assets/images/box-check.png') no-repeat center / contain"
                                    ></span>
                                </span>
                                <p
