<template>
    ...
    >
        <PopoverPanel
            class="absolute pb-6 top-16 left-0 right-0 z-10 mt-0 flex main-container"
        >
            <PopoverButton
                as="div"
                class="w-screen p-5 bg-white shadow-md grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-5 gap-4 rounded-[10px]"
            >
                <!-- categories  -->
                <div
                ...
                <div
                    class="col-span-4 max-h-[505px] overflow-y-scroll scrollbar-hide"
                >
                    <SubcategoryList :subcategories="currentSubcategory" />
                </div>
            </PopoverButton>
        </PopoverPanel>
    </transition>
