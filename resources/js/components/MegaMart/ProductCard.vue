<template>
    <div
        class="w-full self-stretch cursor-pointer bg-white rounded-lg shadow-[0px_2px_12px_0px_rgba(0,0,0,0.16)] inline-flex flex-col justify-start items-start overflow-hidden transition-all duration-200 group"
    >
        <div
        ...
        >
            <RouterLink :to="`/products/${props.product?.slug}`" class="h-full w-full">
                <img
                    class="w-full h-full group-hover:scale-110 transition-all duration-700"
