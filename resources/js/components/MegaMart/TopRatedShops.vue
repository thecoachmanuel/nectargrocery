<template>
    <div>
        <div class="container-2 py-3 md:py-6 lg:py-12">
            <CounterContainer />
        </div>
        <section
            class="bg-[url('https://i.ibb.co.com/rVsfM1Y/top-rated-shops-bg.png')] py-4 bg-no-repeat bg-cover bg-end relative overflow-hidden"
        >
            <SectionContainerV4
            ...
            >
                <div
                    class="w-96 h-96 bg-green-500 rounded-full blur-[300px]"
                ></div>
            </div>
        </section>
    </div>
...
import ShopCardTop from "../MegaMart/ShopCardTop.vue"
