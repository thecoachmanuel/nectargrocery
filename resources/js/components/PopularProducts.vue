    ...
    <SectionContainer :title="'Popular Products'" :isLoading="isLoading">
            ...
            <div class="pt-4">
                ...
                >
                    <button
                        ...
                        :class="currentTab == 'all' ? 'tab_link_active' : ''"
                    ...
                    <button
                        class="capitalize tab_links"
                        :class="tab.id == currentTab ? 'tab_link_active' : ''"
        ...
        <div>
            <section class="hidden lg:grid grid-cols-6 gap-6 mt-[32px]">
                ...
                >
                    <img :src="master.offerBanners[3]?.offer_banner" alt="" />
                    <SkeletonLoader class="w-full h-full " v-if="isCategoryProductLoading"/>
