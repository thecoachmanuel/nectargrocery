<template>
    <div
        class="self-stretch cursor-pointer bg-neutral-100 rounded-lg outline outline-1 outline-offset-[-1px] outline-gray-100 inline-flex flex-col justify-start items-start overflow-hidden transition-all duration-200 hover:bg-[rgba(var(--color-primary-rgb),0.03)] hover:border-none hover:shadow-[0px_0px_8px_0px_rgba(81,175,91,0.24)] hover:outline hover:outline-green-200 group"
    >
        <div
            ...
            >
                ...
                >
                    <div class="flex justify-start items-center gap-0.5">
                        <RiStarFill class="w-[14px] text-primary-300" />
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <p
                        class="w-full inline-block text-zinc-900 text-base font-semibold leading-normal h-12 overflow-hidden"
                    >
