            ...
            >
                ...
                >
                    ...
                    >
                        <span
                            class="w-full h-full"
                            style="display: block; background-color: var(--primary); -webkit-mask: url('/assets/images/phone.svg') no-repeat center / contain; mask: url('/assets/images/phone.svg') no-repeat center / contain"
                        ></span>
                    </span>
                ...
                >
                    ...
                    >
                        <span
                            class="w-full h-full"
                            style="display: block; background-color: var(--primary); -webkit-mask: url('/assets/images/email.svg') no-repeat center / contain; mask: url('/assets/images/email.svg') no-repeat center / contain"
                        ></span>
                    </span>
