            ...
            if (data.product_id) {
                ...
                axios.post("/cart/store", data, {
                    headers: {
                        ...
                        Currency_Id: masterStore.selectedCurrency?.id ?? masterStore.currency?.id ?? 1,
                    ...
                    if (!data.is_buy_now) {
                        ...
                        if (this.selectedShopIds.length === 0 && this.products && this.products.length > 0) {
                            this.selectedShopIds = this.products.map((s) => s.shop_id);
                        }
                        toast(content, {
                            type: "default",
