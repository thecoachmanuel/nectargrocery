            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="mt-3">
                            <x-input label="Minimum Discount" onlyNumber="true" name="discount" type="text"
                                required="true" placeholder="Enter discount" :value="$flashSale->discount" />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea required name="description" class="form-control @error('description') is-invalid @enderror" rows="3"
                                placeholder="Enter short description">{{ old('description') ?? $flashSale->description }}</textarea>
                            @error('description')
                    ...
                    <div class="col-lg-4">
                        <div>
                         ...
                         <x-image-picker name="thumbnail" :value="$flashSale->thumbnail" />
                    </div>
                </div>
